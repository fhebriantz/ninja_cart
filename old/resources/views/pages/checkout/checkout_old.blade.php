						...
						<div class="col-sm-12">
							...
							<div class="p-10">
									...
									@foreach (Cart::content() as $cart)
									  ...
									  <div class='xtable_row'>
									    ...
									    <div class='xtable_small'>
									      ...
									      <div class='xtable_cell'>Rp. {{number_format($cart->price,0,'','.')}}</div>
									    </div>

									    <div class='xtable_small'>
									      <div class='xtable_cell'>Sub Total</div>
									      <div class='xtable_cell'>Rp. {{number_format($cart->subtotal,0,'','.')}}</div>
									    </div>
								...
								<form id="insert_order" method="POST" action="{{url('/insert_order')}}">
									{{ csrf_field() }}
									<div class="g-recaptcha"   data-sitekey="6LdXgZUUAAAAAFdcbwxlpQYMBD8L94HgAuZpQjKy"></div>
	...
	$('#district').on('change',function(e){
      ...
      $.get('ajax-district?district_id=' + district_id, function(data){
        ...
        $.each(data, function(index, villageObj){
          ...
          $('#village').append('<option value="'+villageObj.name+'" data-id="'+villageObj.id+'">'+villageObj.name+'</option>');
