...
<html>
  <head>
    ...
    <title>Ninja Transactional Email</title>
    <style>
      /* -------------------------------------
          GLOBAL RESETS
      ------------------------------------- */
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
						  ...
						  <a href="#home" class="active"><img style="height: 50px; width: auto;"  src="http://54.169.60.212/onlinestore/public/image/logo.png" alt=""></a>
						</div>
						<br>

                        <p>Hi {{$name}}, berikut daftar belanja untuk id order {{$transaction->id_order}}:</p>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="content-block powered-by">
                    Powered by <a href="www.ninjaxpress.co">Ninja Express</a>.
                  </td>
                </tr>
              </table>
            </div>
