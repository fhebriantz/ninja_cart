                ...
                <div class="panel-body">
                    <div class="responsive-table">
                        <table class="table">    
                            ...
                            <tr>
                                <td>Used Quota</td>
                                <td><input type="text" class="form-control" name="quota" value="<?php echo e($data_coupon->quota_used); ?>" style="width: 100%" readonly=""></td>
                            </tr> 
                            <tr>
                                <td>Nominal</td>
...
<?php /* /var/www/html/ninja_cms_new/resources/views/pages/cms/coupon/view.blade.php */ ?>