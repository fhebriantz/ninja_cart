						...
						<?php echo e(csrf_field()); ?>
	                        ...
	                        <table class="table">  
                                <tr>
                                    ...
                                    <td><input type="text"  class="form-control" name="from_zone" placeholder="Code of Zone" value="<?php echo e(old('from_zone')); ?>" style="width: 100%"></td>
                                </tr>  
                                <tr>
                                    <td>To Zone <em style="color:red">*</em></td>
                                    <td><input type="text"  class="form-control" name="to_zone" placeholder="Code of Zone" value="<?php echo e(old('to_zone')); ?>" style="width: 100%"></td>
                                </tr>        
                                <!--<tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text"  class="form-control" name="sla" placeholder="1-2" value="<?php echo e(old('sla')); ?>" style="width: 100%"></td>
                                </tr> 
                                <tr>
...
<?php /* /var/www/html/ninja_cms_new/resources/views/pages/cms/shipment/create.blade.php */ ?>