                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control selectpicker" data-show-subtext="true" data-live-search="true" name="zone" style="width: 100%">
                                            ...
                                            <?php $__currentLoopData = $list_zone; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($list->to_zone); ?>" <?php echo e(($data_village->zone == $list->to_zone ? 'selected':'')); ?> ><?php echo e($list->to_zone); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </td>
                                </tr>           
...
<?php /* /var/www/html/ninja_cms_new/resources/views/pages/cms/village/edit.blade.php */ ?>