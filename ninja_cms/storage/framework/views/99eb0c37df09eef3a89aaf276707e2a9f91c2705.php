            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="responsive-table">
                        ...
                        <?php endif; ?>
                    	<form method="POST" action="<?php echo e(url('/regency/create')); ?>">
						<?php echo e(csrf_field()); ?>
	                        ...
	                        <table class="table">  
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control selectpicker" data-show-subtext="true" data-live-search="true" name="province_id" style="width: 100%">
                                            ...
                                            <option value="<?php echo e($list->id); ?>" <?php echo e((old('province_id') == $list->id ? 'selected':'')); ?> ><?php echo e($list->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </td>
                                </tr>       
                                <tr>
                                    ...
                                    <td><input type="text"  class="form-control" name="name" placeholder="Regency Name" value="<?php echo e(old('name')); ?>" style="width: 100%"></td>
                                </tr>         
                                <tr>
...
<?php /* /var/www/html/ninja_cms_new/resources/views/pages/cms/regency/create.blade.php */ ?>