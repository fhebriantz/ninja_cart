                    ...
                    <div class="responsive-table">
                        ...
                        <table id="datatables-example" class="table table-striped table-bordered" width="100%" cellspacing="0">                        
                            ...
                            <tbody>
                                ...
                                <tr>    
                                    <td><?php echo e($no++); ?></td>
                                    <td><?php echo e($data->shipment_type); ?></td>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" action="<?php echo e(url('/shipment/'.$data->id.'/delete')); ?>">
                                            ...
                                            <input class="btn btn-danger" type="submit" name="delete" value="Delete" onclick="return confirm('Are you sure want to delete caption <?php echo e($data->shipment_type); ?> <?php echo e($data->zona); ?>?');"> 
...
<?php /* C:\xampp\htdocs\ninja_cms_new\resources\views/pages/cms/shipment/index.blade.php */ ?>