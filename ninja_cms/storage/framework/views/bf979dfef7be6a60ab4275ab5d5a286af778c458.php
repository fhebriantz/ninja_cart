            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="responsive-table">
                        ...
                        <?php endif; ?>
                    	<form method="POST" action="<?php echo e(url('/district/'.$data_district->id.'/edit')); ?>">
						<?php echo e(csrf_field()); ?>
	                        ...
	                        <table class="table">  
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control selectpicker" data-show-subtext="true" data-live-search="true" name="regency_id" style="width: 100%" disabled>
                                            ...
                                            <option value="<?php echo e($list->id); ?>" <?php echo e(($data_district->regency_id == $list->id ? 'selected':'')); ?> ><?php echo e($list->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </td>
                                </tr>       
                                <tr>
                                    ...
                                    <td><input type="text"  class="form-control" name="name" placeholder="District Name" value="<?php echo e($data_district->name); ?>" style="width: 100%"></td>
                                </tr>         
                                <tr>
                                    <td>Status <em style="color:red">*</em></td>
                                    <td>
                                        <select name="status"  class="form-control" style="width: 100%">
                                            <option value="1" <?php echo e(($data_district->is_active=='1' ? 'Selected':'')); ?> >Active</option>
                                            <option value="0" <?php echo e(($data_district->is_active=='0' ? 'Selected':'')); ?> >Inactive</option>
                                        </select>
                                    </td>
                                </tr> 
...
<?php /* /var/www/html/ninja_cms_new/resources/views/pages/cms/district/edit.blade.php */ ?>