						...
						{{ csrf_field() }}
	                        <table class="table">  
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control selectpicker" data-show-subtext="true" data-live-search="true" name="regency_id" style="width: 100%">
                                            ...
                                            <option value="{{$list->id}}" {{ (old('regency_id') == $list->id ? 'selected':'') }} >{{$list->name}}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                </tr>       
                                <tr>
                                    ...
                                    <td><input type="text"  class="form-control" name="name" placeholder="District Name" value="{{ old('name') }}" style="width: 100%"></td>
                                </tr>         
                                <tr>
